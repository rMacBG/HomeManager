...
namespace HomeManager.Data.Migrations
{
    ...
    [Migration("20250512132252_ChangedHomeTypeToEnum")]
    partial class ChangedHomeTypeToEnum
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HomeManager.Data.Data.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FullName = "Admin User",
                            PasswordHash = "$2a$11$SJ.3LN4.yQig1y5RyIeGK.Xp4FaPxnua6pYGl71ljVzr2ZtFEcdiC",
