...
namespace HomeManager.Data.Migrations
{
    ...
    [Migration("20250821075726_AddingRegionAndCityToHome")]
    partial class AddingRegionAndCityToHome
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HomeManager.Data.Data.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FullName = "Admin User",
                            PasswordHash = "$2a$11$LfZUj8BdEzevsQWMoPEmcuPFD90P560do1tqbprVSilpJ5yUph44a",
