...
namespace HomeManager.Data.Migrations
{
    ...
    [Migration("20250811175256_addingHomeStuffToConversation")]
    partial class addingHomeStuffToConversation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HomeManager.Data.Data.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FullName = "Admin User",
                            PasswordHash = "$2a$11$iSHpYNmbpKPml3wUHpCHguC5R11suP4pgEfMJuZWz/.l9eMvTCd76",
